package app.android.rxwanandroidjava.widget;
...
public class RecyclerViewBanner extends FrameLayout {
    ...
    private boolean isAllowCirculation = true;
    ...
    public RecyclerViewBanner(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mInterval = a.getInt(R.styleable.RecyclerViewBanner_rvb_interval, 2000);
...
//        }
    ...
    public void setShowIndicator(boolean show) {
        if (mLinearLayout != null) {
            mLinearLayout.setVisibility(show ? VISIBLE : GONE);
        }
    }
     ...
     * @param allow
     */
    public void setAllowCirculation(boolean allow) {
        this.isAllowCirculation = allow;
    }
    ...
    private void switchIndicator() {
        if (mLinearLayout != null && mLinearLayout.getChildCount() > 0) {
            ...
            if (indicatorListener != null) {
                indicatorListener.onSelectIndicator(currentIndex % mData.size());
            }
        }
    }
    ...
    public void setOnIndicatorListener(IndicatorListener indicatorListener) {
    ...
    public interface IndicatorListener {
        void onSelectIndicator(int position);
    }
